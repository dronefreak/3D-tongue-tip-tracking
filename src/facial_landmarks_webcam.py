...
def main():
    """Parse CLI arguments and run real-time webcam tongue-tip tracking."""
    ...
    ap.add_argument("-c", "--camera", type=int, default=0, help="camera device index (default: 0)")
    ap.add_argument("-w", "--width", type=int, default=640, help="frame width (default: 640)")
    ...
    ap.add_argument("--fps", type=int, default=30, help="target FPS for recording (default: 30)")
